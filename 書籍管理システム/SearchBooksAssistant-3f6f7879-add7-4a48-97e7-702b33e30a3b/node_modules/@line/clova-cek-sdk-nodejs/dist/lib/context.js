...
var Context = /** @class */ (function () {
     ...
     * @memberOf Context
     */
    Context.prototype.getSlotValueTypes = function () {
        var request = this.requestObject.request;
        if (!request.intent || !request.intent.slots) {
            return {};
        }
        return Object.values(request.intent.slots)
            .filter(function (curr) { return curr.valueType; })
            .reduce(function (acc, curr) {
            var _a;
            return Object.assign({}, acc, (_a = {}, _a[curr.name] = curr.valueType, _a));
        }, {});
    };
    /**
     ...
     * @memberOf Context
     */
    Context.prototype.getSlotUnits = function () {
        var request = this.requestObject.request;
        if (!request.intent || !request.intent.slots) {
            return {};
        }
        return Object.values(request.intent.slots)
            .filter(function (curr) { return curr.unit; })
            .reduce(function (acc, curr) {
            var _a;
            return Object.assign({}, acc, (_a = {}, _a[curr.name] = curr.unit, _a));
        }, {});
    };
    /**
     ...
     * @memberOf Context
     */
    Context.prototype.getSlotValueType = function (slotName) {
     ...
     * @memberOf Context
     */
    Context.prototype.getSlotUnit = function (slotName) {
